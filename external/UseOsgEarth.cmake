...
elseif(OMEGA_OS_LINUX)
  ...
  endforeach()
	...
	# OSX
    foreach( C ${OSGEARTH_COMPONENTS} )
		set(${C}_LIBRARY ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/osgPlugins-3.3.0/lib${C}.dylib)
		set(${C}_LIBRARY_DEBUG ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/osgPlugins-3.3.0/lib${C}d.dylib)
        set(OSGEARTH_LIBS ${OSGEARTH_LIBS} optimized ${${C}_LIBRARY} debug ${${C}_LIBRARY_DEBUG} CACHE INTERNAL "")
	endforeach()
endif()
